...
class OrderViewModel @Inject constructor(
    ...
    fun placeOrder(order: Order){
        ...
        //batch just for write
        //transaction write and read
        firestore.runBatch{batch ->


            //Add the order into user-ordes collection
            ...
            //Delete products from the user cart collection
            //delete each document inside that collection
